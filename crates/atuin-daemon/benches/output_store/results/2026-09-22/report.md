...
**The adjacent [report.json](report.json) remains the original two-engine seed-42 raw report. It is not an aggregate for this analysis.** The separate source datasets and derived statistics are indexed in [Sources and reproducibility](#9-sources-and-reproducibility).
...
| Legacy two-engine seed-42 report | [report.json](report.json), retained unchanged; not this report's aggregate |
